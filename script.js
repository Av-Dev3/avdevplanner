...
const supabase = supabase.createClient("https://hrlctpqyckkltfuagsxq.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhybGN0cHF5Y2trbHRmdWFnc3hxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTAyODkwNDMsImV4cCI6MjA2NTg2NTA0M30.FCxdMd6vh8C_YEp-Mf67TNOR7mtxkVlJSSFxSc8Y78k");
...
if (container) {
  ...
  function formatDate(dateStr) {
    ...
    const suffix = (d => d % 10 === 1 && d !== 11 ? "st" :
                             d % 10 === 2 && d !== 12 ? "nd" :
                             d % 10 === 3 && d !== 13 ? "rd" : "th")(day);
